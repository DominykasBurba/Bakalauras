...
/// <summary>
/// Idempotent sample data for portfolio views (units, images, occupancies). Development only.
/// Expects buildings and users from database/seed.sql (12 buildings, users 1–16).
/// </summary>
public static class DemoPortfolioSeed
{
    public static readonly string[] SqlStatements =
    [
        // Units across all buildings — ON CONFLICT keeps re-runs safe
        """
        ...
        // Extra vacant units for admin testing (assign occupant / room dropdown)
        """
        INSERT INTO units (building_id, unit_code, floor, area_sqm, notes, photo_urls) VALUES
        ...
        // Gallery images (placeholder photos)
        """
        ...
        // Prior (ended) stay — user 2 moved from 101 to 204
        """
        ...
        // Active occupancies — one open stay per resident unit
        """
        INSERT INTO occupancies (unit_id, user_id, started_at, ended_at)
        ...
        // Link residents to building + unit row (matches assignOccupancy behaviour)
        """
        ...
        // Extra maintenance tickets so more buildings have open work
        """
        ...
        // Demo technician profiles (company names for catalog / directory)
        """
        ...
        // Service catalog — broad categories (idempotent by name)
        """
        ...
        // Links: John Smith (12), Maria (13), David (14), Alex (15), Jordan (16)
        """

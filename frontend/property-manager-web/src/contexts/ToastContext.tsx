...
/** Safe for components that may render outside ToastProvider (e.g. tests). */
export function useToastOptional(): ToastContextValue['showToast'] | null {
  return useContext(ToastContext)?.showToast ?? null
}

...
/**
 * Forces new/declined residents onto the profile completion flow before the rest of the app.
 */
export function ResidentProfileGate({ children }: { children: React.ReactNode }) {
  const { auth } = useAuth()
